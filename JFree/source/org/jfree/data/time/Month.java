...
public class Month extends RegularTimePeriod implements Serializable {
    ...
    public int compareTo(Object o1) {
        ...
        // -----------------------------------------------
            ...
            // more difficult case - evaluators later...
            result = 0;
        }
    ...
    public static Month parseMonth(String s) {
        ...
        if (month == -1) {
            throw new TimePeriodFormatException("Can't evaluators the month.");
        }
        if (year == null) {
            throw new TimePeriodFormatException("Can't evaluators the year.");
        }
